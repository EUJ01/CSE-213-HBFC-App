 ...
 * @author Admin
 */
public class HeadOfBranchT1AssignTasksSceneController implements Initializable {

    @FXML
    private DatePicker assignTaskDatePicker;
    @FXML
    private ComboBox<?> assignTaskDepartmentComboBox;
    @FXML
    private TextField assignTaskTopicTextField;
    @FXML
    private TextField assignTaskDetailsTextField;
    ...
    @FXML
    private void assignTaskOnClick(MouseEvent event) {
    }
