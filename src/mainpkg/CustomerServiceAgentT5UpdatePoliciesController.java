 ...
 */
public class CustomerServiceAgentT5UpdatePoliciesController implements Initializable {

    @FXML
    private TableView<?> policyTableView;
    @FXML
    private TableColumn<?, ?> policyIDTableColumn;
    @FXML
    private TableColumn<?, ?> policyNameTableColumn1;
    @FXML
    private TableColumn<?, ?> implementedDateTableColumn11;
    @FXML
    ...
    @FXML
    private void goBackToDashBoardButtonOnClick(MouseEvent event) throws IOException {
...
//        LoanOfficerT1TotalApplicationForSelectionController controller =  loader.getController();
    ...
    @FXML
    private void implementButtonOnClick(MouseEvent event) {
    }
