 ...
 * @author EUJ
 */
public class CollectionAgentT1TrackBorrowerAccountSceneController implements Initializable {

    @FXML
    private TableView<?> borrowerTable;
    @FXML
    private TableColumn<?, ?> borrowerNameColumn;
    @FXML
    private TableColumn<?, ?> borrowerNIDColumn;
    @FXML
    private TableColumn<?, ?> borrowerDueDateColumn;
    @FXML
    private TableColumn<?, ?> borrowerDateColumn;
    @FXML
    ...
    @FXML
    private void showBorrowerAccountsOnClick(MouseEvent event) {
    }
