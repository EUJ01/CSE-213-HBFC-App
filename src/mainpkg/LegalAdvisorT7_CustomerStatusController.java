 ...
 * @author aqib
 */
public class LegalAdvisorT7_CustomerStatusController implements Initializable {
    ...
    @FXML
    private void LogoutOnClick(MouseEvent event) throws IOException {   FXMLLoader loader = new FXMLLoader();
