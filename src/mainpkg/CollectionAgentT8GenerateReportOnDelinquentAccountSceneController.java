 ...
 * @author EUJ
 */
public class CollectionAgentT8GenerateReportOnDelinquentAccountSceneController implements Initializable {

    @FXML
    private DatePicker delinquentReportStartDatePicker;
    @FXML
    private LineChart<?, ?> delinquentLineChart;
    ...
    @FXML
    private void generateLineChartButtonOnClick(MouseEvent event) {
    }
