 ...
 */
public class LoanOfficerT6LoanAmortizationScheduleController implements Initializable {
    ...
    @FXML
    private TableColumn<?, ?> begininngBalanceTableColumn;
    @FXML
    private TableColumn<?, ?> paymentTableColumn;
    @FXML
    private TableColumn<?, ?> endingBalanceTableColumn;
