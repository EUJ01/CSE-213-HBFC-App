 ...
 * @author EUJ
 */
public class CollectionAgentT6SendDemandLetterToDelinquentController implements Initializable {

    @FXML
    private DatePicker demandLetterDatePicker;
    @FXML
    private TextField demandLetterNameTextField;
    @FXML
    private TextArea demandLetterDetailsTextArea;
    @FXML
    private TableView<?> demantDelinquentTable;
    @FXML
    ...
    @FXML
    private void sendFeedbackToHOBOnClick(MouseEvent event) {
    }
