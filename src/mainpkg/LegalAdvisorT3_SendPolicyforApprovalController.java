 ...
 * @author aqib
 */
public class LegalAdvisorT3_SendPolicyforApprovalController implements Initializable {

    @FXML
    private TableView<?> PendingProposedPolicytableview;
    @FXML
    private TableColumn<?, ?> PendingProposedPolicycolumn1;
    @FXML
    private TextField PolicyID;
    @FXML
    private TextArea PendingProposedPolicyDetails;
    ...
    @FXML
    private void DisplayPendingProposedPolicy(MouseEvent event) {
    }

    @FXML
    private void SendProposedPolicyToHOB(MouseEvent event) {
    }
