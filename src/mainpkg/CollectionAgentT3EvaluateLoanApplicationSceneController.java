 ...
 * @author EUJ
 */
public class CollectionAgentT3EvaluateLoanApplicationSceneController implements Initializable {

    @FXML
    private TableView<?> loanApplicationTable;
    @FXML
    private TableColumn<?, ?> loanOfficerIdColumn;
    @FXML
    private TableColumn<?, ?> loanApplicationTypeColumn;
    @FXML
    private TableColumn<?, ?> borrowerStatusColumn;
    @FXML
    private TextArea applicationRejectReasonTextArea;
    ...
    @FXML
    private void approveAndSendtoLoanOfficerOnClick(MouseEvent event) {
    }

    @FXML
    private void rejectAndSendtoLoanOfficerOnClick(MouseEvent event) {
    }
