 ...
 * @author Admin
 */
public class HeadOfBranchT2LoanProposalsSceneController implements Initializable {
    ...
    @FXML
    private Label loanProposalDetailsLabel;
    ...
    @FXML
    private void approveLoanProposalOnClick(MouseEvent event) {
    }

    @FXML
    private void declineLoanProposalOnClick(MouseEvent event) {
    }
