 ...
 */
public class CustomerServiceAgentT4GenerateReportSceneController implements Initializable {
    ...
    @FXML
    private PieChart complainReportPieChart;
...
//        LoanOfficerT1TotalApplicationForSelectionController controller =  loader.getController();
    ...
    @FXML
    private void generatePieChartButtonOnClick(MouseEvent event) {
    }
