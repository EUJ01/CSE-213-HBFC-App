 ...
 * @author EUJ
 */
public class CollectionAgentT7ProvideFeedbackToHOBSceneController implements Initializable {

    @FXML
    private DatePicker cAFeedbackDatePicker;
    @FXML
    private TextField cAFeedbackTopicTextField;
    @FXML
    private TextArea cAFeedbackDetailsTextArea;
