 ...
 */
public class CustomerServiceAgentT1PaymentConfirmSceneController implements Initializable {

    @FXML
    private TableView<?> confirmationTableView;
    @FXML
    private TableColumn<?, ?> borrowerNIDTableColumn;
    @FXML
    private TableColumn<?, ?> borrowerNameTableColumn1;
    @FXML
    private TableColumn<?, ?> amountTableColumn11;
    @FXML
...
//        LoanOfficerT1TotalApplicationForSelectionController controller =  loader.getController();
    ...
    @FXML
    private void denyButtonOnClick(MouseEvent event) {
    }
